...
--
-- テーブルのデータのダンプ `c_dtb_anything`
--

INSERT INTO `c_dtb_anything` (`id`, `any_input`, `any_select`, `discriminator_type`) VALUES
(1, 'asdf', 'standard', 'anything'),
(2, 'asdf', 'expedited', 'anything'),
(3, 'asdf', 'priority', 'anything'),
(8, 'ai2022-09-15 18:58:39', 'as2022-09-15 18:58:39', 'anything'),
(9, 'ai2022-09-15 19:15:55', 'as2022-09-15 19:15:55', 'anything'),
(10, 'ai2022-09-15 19:18:05', 'as2022-09-15 19:18:05', 'anything'),
(11, 'ai2022-09-15 19:19:57', 'as2022-09-15 19:19:57', 'anything'),
(12, 'ai2022-09-15 19:26:58', 'as2022-09-15 19:26:58', 'anything'),
(13, 'ai2022-09-15 19:29:34', 'as2022-09-15 19:29:34', 'anything'),
(14, 'ai2022-09-16 13:55:35', 'as2022-09-16 13:55:35', 'anything');

-- --------------------------------------------------------

--
-- テーブルの構造 `c_dtb_anything_detail`
--

CREATE TABLE `c_dtb_anything_detail` (
  `id` int(10) UNSIGNED NOT NULL,
  `anything_id` int(10) UNSIGNED DEFAULT NULL,
  `any_detail_input` varchar(255) DEFAULT NULL,
  `any_detail_select` varchar(255) DEFAULT NULL,
  `discriminator_type` varchar(255) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

--
-- テーブルのデータのダンプ `c_dtb_anything_detail`
--

INSERT INTO `c_dtb_anything_detail` (`id`, `anything_id`, `any_detail_input`, `any_detail_select`, `discriminator_type`) VALUES
(1, 1, 'asdf', 'AAA', 'anythingdetail'),
(2, 2, 'asdf', 'BBB', 'anythingdetail'),
(3, 3, 'asdf', 'CCC', 'anythingdetail'),
(4, 1, 'asdf', 'DDD', 'anythingdetail'),
(5, 2, 'asdf', 'EEE', 'anythingdetail'),
(6, 3, 'asdf', 'FFF', 'anythingdetail'),
(7, NULL, 'di2022-09-15 19:15:55', 'ds2022-09-15 19:15:55', 'anythingdetail'),
(8, NULL, 'di2022-09-15 19:15:55', 'ds2022-09-15 19:15:55', 'anythingdetail'),
(9, NULL, 'di2022-09-15 19:15:55', 'ds2022-09-15 19:15:55', 'anythingdetail'),
(10, NULL, 'di_12022-09-15 19:18:05', 'ds_12022-09-15 19:18:05', 'anythingdetail'),
(11, NULL, 'di_22022-09-15 19:18:05', 'ds_22022-09-15 19:18:05', 'anythingdetail'),
(12, NULL, 'di_32022-09-15 19:18:05', 'ds_32022-09-15 19:18:05', 'anythingdetail'),
(13, NULL, 'di_12022-09-16 13:55:35', 'ds_12022-09-16 13:55:35', 'anythingdetail'),
(14, NULL, 'di_22022-09-16 13:55:35', 'ds_22022-09-16 13:55:35', 'anythingdetail'),
(15, NULL, 'di_32022-09-16 13:55:35', 'ds_32022-09-16 13:55:35', 'anythingdetail');

-- --------------------------------------------------------

--
-- テーブルの構造 `c_dtb_any_category`
--

CREATE TABLE `c_dtb_any_category` (
  `id` int(10) UNSIGNED NOT NULL,
  `parent_any_category_id` int(10) UNSIGNED DEFAULT NULL,
  `any_category_name` varchar(255) NOT NULL,
...
--
-- テーブルの構造 `c_dtb_any_product`
--

CREATE TABLE `c_dtb_any_product` (
  `id` int(10) UNSIGNED NOT NULL,
  `any_product_status_id` smallint(5) UNSIGNED DEFAULT NULL,
  `any_input` varchar(255) NOT NULL,
  `any_select` varchar(255) NOT NULL,
  `discriminator_type` varchar(255) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
--
-- テーブルのデータのダンプ `c_dtb_any_product`
--

INSERT INTO `c_dtb_any_product` (`id`, `any_product_status_id`, `any_input`, `any_select`, `discriminator_type`) VALUES
(1, NULL, 'ai2022-09-16 13:55:40', 'as2022-09-16 13:55:40', 'anyproduct');

-- --------------------------------------------------------

--
-- テーブルの構造 `c_dtb_any_product_anystock`
--

CREATE TABLE `c_dtb_any_product_anystock` (
  `id` int(10) UNSIGNED NOT NULL,
  `any_product_class_id` int(10) UNSIGNED DEFAULT NULL,
  `anyStock` decimal(10,0) DEFAULT NULL,
  `discriminator_type` varchar(255) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
--
-- テーブルの構造 `c_dtb_any_product_category`
--

CREATE TABLE `c_dtb_any_product_category` (
  `any_product_id` int(10) UNSIGNED NOT NULL,
  `any_category_id` int(10) UNSIGNED NOT NULL,
  `discriminator_type` varchar(255) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
--
-- テーブルの構造 `c_dtb_any_product_class`
--

CREATE TABLE `c_dtb_any_product_class` (
  `id` int(10) UNSIGNED NOT NULL,
  `any_product_id` int(10) UNSIGNED DEFAULT NULL,
  `any_sale_type_id` smallint(5) UNSIGNED DEFAULT NULL,
  `discriminator_type` varchar(255) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
--
-- テーブルの構造 `c_mtb_any_product_status`
--

CREATE TABLE `c_mtb_any_product_status` (
...
--
-- テーブルの構造 `c_mtb_any_sale_type`
--

CREATE TABLE `c_mtb_any_sale_type` (
  `id` smallint(5) UNSIGNED NOT NULL,
  `name` varchar(255) NOT NULL,
  `sort_no` smallint(5) UNSIGNED NOT NULL,
  `discriminator_type` varchar(255) NOT NULL
...
(17, NULL, 'nyuhuMnLJdu61L5JZIBw2UYhWSVn0st1_1', NULL, '5500.00', '0.00', NULL, '2022-09-01 05:05:47', '2022-09-01 05:05:50', '0', '0', 'cart'),
(24, 1, '1_1', '637fa6866e332b6aa2a34d79f1bcdfd8cf05a809', '11000.00', '0.00', NULL, '2022-09-13 08:26:06', '2022-09-13 08:34:10', '0', '0', 'cart');
...
(26, 10, 24, '5500.00', '2', NULL, 'cartitem');
...
(1, 2, NULL, NULL, NULL, 23, 'テティス', 'てて', 'テティス', 'テテテ', NULL, '4580801', '名古屋市緑区鳴海町', 'テティス', 'deho.chon@dragonagency.co.jp', '11122223333', NULL, '54f9c0085952806576ac85d0945337d11c6ee575bebed66e397de9a3bc6bc2a5', '4f88b4065d', '14y0gs09OHkO5sRVQvgPQuIxDjkkSASa', '2022-09-01 04:12:38', '2022-09-01 04:12:38', '1', '9240.00', NULL, NULL, NULL, '0', '2022-07-27 00:27:32', '2022-09-13 08:25:53', 'customer', 0),
...
(1, 1, NULL, 27, 'aaaa', 'aaaa', 'アイ', 'データ', NULL, '5300000', '大阪市北区', 'aaaaa', '07012341234', '2022-09-01 04:11:17', '2022-09-01 04:11:17', 'customeraddress');
...
(12, 0, NULL, 'heiwadotecadmin', '::1', '2022-09-13 08:28:49', '2022-09-13 08:28:49', 'loginhistory'),
(13, 1, 1, 'admin', '::1', '2022-09-13 08:28:53', '2022-09-13 08:28:53', 'loginhistory');
...
(1, 1, 0, 1, '管理者', 'eccube', 'admin', '07ab695b996b81773a65a7d3916d8b09773dbbac7157b6926514b7e7d44fcf79', 'RB4pduU31nPm1CgRnZec9ysb8njjElrl', 1, NULL, 0, '2022-07-27 00:17:11', '2022-09-13 08:28:53', '2022-09-13 08:28:53', 'member');
...
(18, 1, NULL, 23, NULL, NULL, 3, 10, '373d0f18ad8dfde709e84793bb8a4939c12544c8', '18', NULL, 'テティス', 'てて', 'テティス', 'テテテ', NULL, 'deho.chon@dragonagency.co.jp', '11122223333', '4580801', '名古屋市緑区鳴海町', 'テティス', NULL, '9240.00', '0.00', '0.00', '0.00', '840.00', '9240.00', '9240.00', '銀行振込', NULL, '2022-09-01 04:09:27', '2022-09-01 04:12:38', '2022-09-01 04:12:38', NULL, 'JPY', NULL, NULL, '84', '0', 1, 'order'),
(19, 1, NULL, 23, NULL, NULL, 1, 10, '174a2e962702e9b35242231778c670a84131218f', '19', NULL, 'テティス', 'てて', 'テティス', 'テテテ', NULL, 'deho.chon@dragonagency.co.jp', '11122223333', '4580801', '名古屋市緑区鳴海町', 'テティス', NULL, '11000.00', '0.00', '2000.00', '0.00', '1182.00', '13000.00', '13000.00', '郵便振替', NULL, '2022-09-01 05:06:02', '2022-09-01 05:29:04', NULL, NULL, 'JPY', NULL, NULL, '100', '0', 8, 'order'),
(20, 1, NULL, 23, NULL, NULL, 1, 10, '637fa6866e332b6aa2a34d79f1bcdfd8cf05a809', '20', NULL, 'テティス', 'てて', 'テティス', 'テテテ', NULL, 'deho.chon@dragonagency.co.jp', '11122223333', '4580801', '名古屋市緑区鳴海町', 'テティス', NULL, '11000.00', '0.00', '2000.00', '0.00', '1182.00', '13000.00', '13000.00', '郵便振替', NULL, '2022-09-13 08:26:20', '2022-09-13 08:27:15', NULL, NULL, 'JPY', NULL, NULL, '100', '0', 8, 'order');
...
(118, 18, NULL, NULL, NULL, 1, 1, 2, 3, '手数料', NULL, NULL, NULL, NULL, NULL, '0.00', '1', '0', '10', '0', NULL, 'JPY', 'Eccube\\Service\\PurchaseFlow\\Processor\\PaymentChargePreprocessor', NULL, 'orderitem'),
(124, 18, 2, 11, 21, 1, 1, 1, 1, 'チェリーアイスサンド', 'sand-01', NULL, NULL, NULL, NULL, '2800.00', '2', '280', '10', '0', NULL, 'JPY', NULL, NULL, 'orderitem'),
(125, 18, 2, 11, 22, 1, 1, 1, 1, 'チェリーアイスサンド', 'sand-01', NULL, NULL, NULL, NULL, '2800.00', '1', '280', '10', '0', NULL, 'JPY', NULL, NULL, 'orderitem'),
(132, 18, NULL, NULL, 21, 1, 1, 2, 2, '送料', NULL, NULL, NULL, NULL, NULL, '0.00', '1', '0', '10', '0', NULL, 'JPY', 'Eccube\\Service\\PurchaseFlow\\Processor\\DeliveryFeePreprocessor', NULL, 'orderitem'),
(133, 18, NULL, NULL, 22, 1, 1, 2, 2, '送料', NULL, NULL, NULL, NULL, NULL, '0.00', '1', '0', '10', '0', NULL, 'JPY', 'Eccube\\Service\\PurchaseFlow\\Processor\\DeliveryFeePreprocessor', NULL, 'orderitem'),
(136, 19, NULL, NULL, NULL, 1, 1, 2, 3, '手数料', NULL, NULL, NULL, NULL, NULL, '0.00', '1', '0', '10', '0', NULL, 'JPY', 'Eccube\\Service\\PurchaseFlow\\Processor\\PaymentChargePreprocessor', NULL, 'orderitem'),
(138, 19, 1, 10, 24, 1, 1, 1, 1, '彩のジェラートCUBE', 'cube-09', 'フレーバー', 'サイズ', 'チョコ', '16mm × 16mm', '5000.00', '1', '500', '10', '0', NULL, 'JPY', NULL, NULL, 'orderitem'),
(139, 19, 1, 10, 25, 1, 1, 1, 1, '彩のジェラートCUBE', 'cube-09', 'フレーバー', 'サイズ', 'チョコ', '16mm × 16mm', '5000.00', '1', '500', '10', '0', NULL, 'JPY', NULL, NULL, 'orderitem'),
(168, 19, NULL, NULL, 25, 1, 1, 2, 2, '送料', NULL, NULL, NULL, NULL, NULL, '1000.00', '1', '91', '10', '0', NULL, 'JPY', 'Eccube\\Service\\PurchaseFlow\\Processor\\DeliveryFeePreprocessor', NULL, 'orderitem'),
(169, 19, NULL, NULL, 24, 1, 1, 2, 2, '送料', NULL, NULL, NULL, NULL, NULL, '1000.00', '1', '91', '10', '0', NULL, 'JPY', 'Eccube\\Service\\PurchaseFlow\\Processor\\DeliveryFeePreprocessor', NULL, 'orderitem'),
(172, 20, NULL, NULL, NULL, 1, 1, 2, 3, '手数料', NULL, NULL, NULL, NULL, NULL, '0.00', '1', '0', '10', '0', NULL, 'JPY', 'Eccube\\Service\\PurchaseFlow\\Processor\\PaymentChargePreprocessor', NULL, 'orderitem'),
(178, 20, 1, 10, 28, 1, 1, 1, 1, '彩のジェラートCUBE', 'cube-09', 'フレーバー', 'サイズ', 'チョコ', '16mm × 16mm', '5000.00', '1', '500', '10', '0', NULL, 'JPY', NULL, NULL, 'orderitem'),
(179, 20, 1, 10, 29, 1, 1, 1, 1, '彩のジェラートCUBE', 'cube-09', 'フレーバー', 'サイズ', 'チョコ', '16mm × 16mm', '5000.00', '1', '500', '10', '0', NULL, 'JPY', NULL, NULL, 'orderitem'),
(182, 20, NULL, NULL, 28, 1, 1, 2, 2, '送料', NULL, NULL, NULL, NULL, NULL, '1000.00', '1', '91', '10', '0', NULL, 'JPY', 'Eccube\\Service\\PurchaseFlow\\Processor\\DeliveryFeePreprocessor', NULL, 'orderitem'),
(183, 20, NULL, NULL, 29, 1, 1, 2, 2, '送料', NULL, NULL, NULL, NULL, NULL, '1000.00', '1', '91', '10', '0', NULL, 'JPY', 'Eccube\\Service\\PurchaseFlow\\Processor\\DeliveryFeePreprocessor', NULL, 'orderitem');
...
(11, 2, 2, NULL, NULL, 10, 1, 'sand-01', '97', 0, '5', '3000.00', '2800.00', NULL, 1, '2017-03-07 10:14:52', '2022-09-01 04:12:38', 'JPY', NULL, 'productclass');
...
(11, 11, 1, '97', '2017-03-07 10:14:52', '2022-09-01 04:12:38', 'productstock');
...
(21, 18, NULL, 27, 2, NULL, 'aaaa', 'aaaa', 'アイ', 'データ', NULL, '07012341234', '5300000', '大阪市北区', 'aaaaa', 'サンプル宅配', NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2022-09-01 04:11:41', '2022-09-01 04:12:06', NULL, 'shipping'),
(22, 18, NULL, 23, 2, NULL, 'テティス', 'てて', 'テティス', 'テテテ', NULL, '11122223333', '4580801', '名古屋市緑区鳴海町', 'テティス', 'サンプル宅配', NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2022-09-01 04:11:41', '2022-09-01 04:12:06', NULL, 'shipping'),
(24, 19, NULL, 23, 1, NULL, 'テティス', 'てて', 'テティス', 'テテテ', NULL, '11122223333', '4580801', '名古屋市緑区鳴海町', 'テティス', 'サンプル業者', 2, '午後', NULL, NULL, NULL, NULL, NULL, '2022-09-01 05:06:30', '2022-09-01 05:07:28', NULL, 'shipping'),
(25, 19, NULL, 27, 1, NULL, 'aaaa', 'aaaa', 'アイ', 'データ', NULL, '07012341234', '5300000', '大阪市北区', 'aaaaa', 'サンプル業者', 1, '午前', NULL, NULL, NULL, NULL, NULL, '2022-09-01 05:06:30', '2022-09-01 05:07:28', NULL, 'shipping'),
(28, 20, NULL, 27, 1, NULL, 'aaaa', 'aaaa', 'アイ', 'データ', NULL, '07012341234', '5300000', '大阪市北区', 'aaaaa', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2022-09-13 08:27:13', '2022-09-13 08:27:13', NULL, 'shipping'),
(29, 20, NULL, 23, 1, NULL, 'テティス', 'てて', 'テティス', 'テテテ', NULL, '11122223333', '4580801', '名古屋市緑区鳴海町', 'テティス', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2022-09-13 08:27:13', '2022-09-13 08:27:13', NULL, 'shipping');
...
--
-- テーブルのインデックス `c_dtb_anything_detail`
--
ALTER TABLE `c_dtb_anything_detail`
  ADD PRIMARY KEY (`id`),
  ADD KEY `IDX_34418C2CCFB86097` (`anything_id`);

--
-- テーブルのインデックス `c_dtb_any_category`
--
ALTER TABLE `c_dtb_any_category`
  ADD PRIMARY KEY (`id`),
  ADD KEY `IDX_B156B928F6D3DCA6` (`parent_any_category_id`);

--
-- テーブルのインデックス `c_dtb_any_product`
--
ALTER TABLE `c_dtb_any_product`
  ADD PRIMARY KEY (`id`),
  ADD KEY `IDX_74B6D6D3836F6630` (`any_product_status_id`);

--
-- テーブルのインデックス `c_dtb_any_product_anystock`
--
ALTER TABLE `c_dtb_any_product_anystock`
  ADD PRIMARY KEY (`id`),
  ADD KEY `IDX_D23CE8CECAB2B557` (`any_product_class_id`);

--
-- テーブルのインデックス `c_dtb_any_product_category`
--
ALTER TABLE `c_dtb_any_product_category`
  ADD PRIMARY KEY (`any_product_id`,`any_category_id`),
  ADD KEY `IDX_16626B8BC0D75DDD` (`any_product_id`),
  ADD KEY `IDX_16626B8B611FD85A` (`any_category_id`);

--
-- テーブルのインデックス `c_dtb_any_product_class`
--
ALTER TABLE `c_dtb_any_product_class`
  ADD PRIMARY KEY (`id`),
  ADD KEY `IDX_9E8DC0B1C0D75DDD` (`any_product_id`),
  ADD KEY `IDX_9E8DC0B1759B2CFA` (`any_sale_type_id`);
...
--
-- テーブルのインデックス `c_mtb_any_product_status`
--
ALTER TABLE `c_mtb_any_product_status`
  ADD PRIMARY KEY (`id`);

--
-- テーブルのインデックス `c_mtb_any_sale_type`
--
ALTER TABLE `c_mtb_any_sale_type`
  ADD PRIMARY KEY (`id`);
...
--
-- テーブルの AUTO_INCREMENT `c_dtb_anything_detail`
--
ALTER TABLE `c_dtb_anything_detail`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=16;

--
-- テーブルの AUTO_INCREMENT `c_dtb_any_category`
--
ALTER TABLE `c_dtb_any_category`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- テーブルの AUTO_INCREMENT `c_dtb_any_product`
--
ALTER TABLE `c_dtb_any_product`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- テーブルの AUTO_INCREMENT `c_dtb_any_product_anystock`
--
ALTER TABLE `c_dtb_any_product_anystock`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- テーブルの AUTO_INCREMENT `c_dtb_any_product_class`
--
ALTER TABLE `c_dtb_any_product_class`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;
...
--
-- テーブルの制約 `c_dtb_anything_detail`
--
ALTER TABLE `c_dtb_anything_detail`
  ADD CONSTRAINT `FK_34418C2CCFB86097` FOREIGN KEY (`anything_id`) REFERENCES `c_dtb_anything` (`id`);

--
-- テーブルの制約 `c_dtb_any_category`
--
ALTER TABLE `c_dtb_any_category`
  ADD CONSTRAINT `FK_B156B928F6D3DCA6` FOREIGN KEY (`parent_any_category_id`) REFERENCES `c_dtb_any_category` (`id`);

--
-- テーブルの制約 `c_dtb_any_product`
--
ALTER TABLE `c_dtb_any_product`
  ADD CONSTRAINT `FK_74B6D6D3836F6630` FOREIGN KEY (`any_product_status_id`) REFERENCES `c_mtb_any_product_status` (`id`);

--
-- テーブルの制約 `c_dtb_any_product_anystock`
--
ALTER TABLE `c_dtb_any_product_anystock`
  ADD CONSTRAINT `FK_D23CE8CECAB2B557` FOREIGN KEY (`any_product_class_id`) REFERENCES `c_dtb_any_product_class` (`id`);

--
-- テーブルの制約 `c_dtb_any_product_category`
--
ALTER TABLE `c_dtb_any_product_category`
  ADD CONSTRAINT `FK_16626B8B611FD85A` FOREIGN KEY (`any_category_id`) REFERENCES `c_dtb_any_category` (`id`),
  ADD CONSTRAINT `FK_16626B8BC0D75DDD` FOREIGN KEY (`any_product_id`) REFERENCES `c_dtb_any_product` (`id`);

--
-- テーブルの制約 `c_dtb_any_product_class`
--
ALTER TABLE `c_dtb_any_product_class`
  ADD CONSTRAINT `FK_9E8DC0B1759B2CFA` FOREIGN KEY (`any_sale_type_id`) REFERENCES `c_mtb_any_sale_type` (`id`),
  ADD CONSTRAINT `FK_9E8DC0B1C0D75DDD` FOREIGN KEY (`any_product_id`) REFERENCES `c_dtb_any_product` (`id`);
